  ...
  return (
    <div>
      <div className="py-8 border-b border-gray-100 mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-1">{t.docsTitle}</h2>
        <p className="text-sm text-gray-500">{t.docsDesc}</p>
      </div>

      {loading ? (
        <div className="text-sm text-gray-400 py-12 text-center">{t.loadingHistory}</div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">{t.noDocsYet}</p>
          <button
          ...
          {sources.length > 0 && (
            <div className="bg-white rounded-xl border border-gray-200 mb-5">
              <div className="px-5 py-4 border-b border-gray-100">
                <p className="text-sm font-semibold text-gray-700">{t.analyzedDocs}</p>
              </div>
              <div className="divide-y divide-gray-100">
                {sources.map((s, i) => (
                  <div key={i} className="px-5 py-3 flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700">{formatSource(s, t.sourceLabels)}</span>
                  </div>
                ))}
              </div>
            </div>
